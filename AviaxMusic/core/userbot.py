...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("moon_sunlight")
                await self.one.join_chat("moon_sunlight")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("moon_sunlight")
                await self.one.join_chat("moon_sunlight")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("moon_sunlight")
                await self.one.join_chat("moon_sunlight")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("moon_sunlight")
                await self.one.join_chat("moon_sunlight")
            except:
                pass
            assistants.append(5)
